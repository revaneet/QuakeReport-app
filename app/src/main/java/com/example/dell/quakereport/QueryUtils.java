...
public class QueryUtils {
    ...
    public static ArrayList<quakeReport> fetchEarthquakeData(String requestURL)
    {
//        try {
//            Thread.sleep(2000);
...
//        }
        ...
        ArrayList<quakeReport> earthquakes=extractFeaturesFromJson(jsonResponse);
        return earthquakes;
    }
    //CREATE URL FROM STRING-URL
    ...
    public static ArrayList<quakeReport> extractFeaturesFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            for(int i=0;i<features.length();i++)
            {
                ...
                earthquakes.add(new quakeReport(mag,loc,dateToDisplay,timeToDisplay,url));
            }
        } catch (Exception e) {
